...
public class LoginBean {
    ...
    public String doLogin() throws IOException {
        try {
            ...
            WebUtils.sendFacesMessage(LOGIN_FORM_DO_LOGIN, "login_page_jdbc_error_ui", null, FacesMessage.SEVERITY_ERROR);
            return null;
        } catch (AuthenticationException e) {
            WebUtils.sendFacesMessage(LOGIN_FORM_DO_LOGIN, "login_page_authentication_error_ui", null, FacesMessage.SEVERITY_ERROR);
            return null;
        }
    }
